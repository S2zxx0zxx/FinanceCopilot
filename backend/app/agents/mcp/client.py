...
Talks to one or more MCP servers (FinCopilot's built-in + any user-supplied).
...
def _parse_servers() -> list[_ServerSpec]:
    ...
    out = [_ServerSpec(name="fincopilot", url=s.builtin_mcp_url)]
