...
SimpleFIN Bridge at https://bridge.simplefin.org), pastes it into FinCopilot,
and FinCopilot claims an Access URL that embeds Basic Auth credentials. From then
