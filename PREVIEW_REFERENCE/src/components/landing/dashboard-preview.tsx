...
import { LayoutDashboard, Receipt, Wallet, PieChart, Sparkles, Settings, TrendingUp } from "lucide-react";
                    ...
                    {dashboardKpis.map((kpi, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className={`text-[10px] font-mono ${kpi.positive ? "text-[var(--success)]" : "text-[var(--danger)]"}`}>{kpi.delta}</span>
                        </motion.div>
                      );
                    })}
                  </div>
