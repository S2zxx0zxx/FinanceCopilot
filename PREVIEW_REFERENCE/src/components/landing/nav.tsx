    ...
    >
      <div className="max-w-7xl mx-auto px-5 sm:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            href="#"
            className="hidden sm:inline-flex items-center text-[13px] font-medium text-[var(--text-secondary)] hover:text-[var(--text)] px-3 py-2 transition-colors"
          >
            Log in
          </a>
            ...
            <SheetContent side="right" className="w-[300px] bg-[var(--bg)] border-[var(--border)] p-0">
              ...
              <nav className="flex flex-col p-3" aria-label="Mobile">
                ...
                <a
                  href="#"
                  onClick={() => setOpen(false)}
                  className="px-3 py-3 text-[15px] text-[var(--text-secondary)] hover:bg-[var(--surface-2)] rounded-[10px] transition-colors"
                >
                  Log in
                </a>
                <a
                  href="#pricing"
                  onClick={() => setOpen(false)}
                  className="mt-2 inline-flex items-center justify-center gap-2 rounded-[10px] bg-[var(--accent)] text-[#0A0F0D] px-4 py-2.5 text-[14px] font-semibold hover:bg-[var(--accent-bright)] transition-colors"
                >
                  Start free
                </a>
              </nav>
