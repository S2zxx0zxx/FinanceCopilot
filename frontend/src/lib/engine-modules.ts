...
export const ENGINE_MODULES: Record<EngineModuleKey, EngineModuleConfig> = {
  assets: {
    ...
    eyebrow: "Net worth & investments",
    description: "Track holdings, valuations, market-priced assets and investment positions inside your FinCopilot workspace.",
    endpoint: "/assets",
  ...
  currencies: {
    ...
    description: "Review supported currencies and the basis for cross-currency reporting.",
    endpoint: "/currencies",
    emptyTitle: "No currencies available",
    emptyDescription: "Supported currency metadata will appear here when available.",
    titleKeys: ["code", "name"],
  ...
  connections: {
    ...
    description: "Review connected banks alongside FinCopilot's India Account Aggregator connection centre.",
    endpoint: "/connections",
    emptyTitle: "No bank connections",
