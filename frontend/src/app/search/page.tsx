  ...
  return (
    <div className="flex flex-col gap-6 max-w-4xl">
      <motion.header initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        <h1 className="font-display font-bold text-[28px] tracking-[-0.02em] capitalize">search</h1>
      ...
      <div className="premium-card p-8 flex flex-col items-center text-center gap-3">
        ...
        <p className="text-[14px] text-[var(--text-secondary)] max-w-sm">This page is under active development. The full search experience will be available shortly.</p>
      </div>
    </div>
  );
}
